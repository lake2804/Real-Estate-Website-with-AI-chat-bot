    ...
    <div class="flex flex-col items-center justify-center w-full h-full lg:w-3/5">
      <div class="relative flex flex-col justify-center w-full h-full px-2 py-8 bg-white rounded-none shadow-xl lg:rounded-3xl lg:px-16 lg:py-16">
        ...
        <div class="mb-8 max-w-[400px] w-full mx-auto">
          <h1 class="mb-2 text-3xl font-bold text-[#F62E56] flex items-center gap-2">
            <svg class="w-7 h-7 text-[#F62E56]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="#F62E56" stroke-width="2" fill="#fff"/><path stroke="#F62E56" stroke-width="2" d="M8 12l2 2 4-4"/></svg>
            Get Started Now
          </h1>
          <p class="text-[#7b1e3a] text-base font-semibold">Let's create your account and enjoy all features!</p>
        </div>
            ...
            <div class="relative">
              <span class="absolute text-gray-400 -translate-y-1/2 left-3 top-1/2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M12.6667 2.66675H3.33334C2.80291 2.66675 2.2942 2.87746 1.91913 3.25253C1.54406 3.62761 1.33334 4.13631 1.33334 4.66675V11.3334C1.33334 11.8638 1.54406 12.3726 1.91913 12.7476C2.2942 13.1227 2.80291 13.3334 3.33334 13.3334H12.6667C13.1971 13.3334 13.7058 13.1227 14.0809 12.7476C14.456 12.3726 14.6667 11.8638 14.6667 11.3334V4.66675C14.6667 4.13631 14.456 3.62761 14.0809 3.25253C13.7058 2.87746 13.1971 2.66675 12.6667 2.66675V2.66675ZM12.22 4.00008L8.00001 7.16675L3.78001 4.00008H12.22ZM12.6667 12.0001H3.33334C3.15653 12.0001 2.98696 11.9298 2.86194 11.8048C2.73691 11.6798 2.66668 11.5102 2.66668 11.3334V4.83341L7.60001 8.53341C7.71541 8.61996 7.85576 8.66675 8.00001 8.66675C8.14426 8.66675 8.28461 8.61996 8.40001 8.53341L13.3333 4.83341V11.3334C13.3333 11.5102 13.2631 11.6798 13.1381 11.8048C13.0131 11.9298 12.8435 12.0001 12.6667 12.0001Z" fill="#899CC9"/>
                </svg>
              </span>
              <input
                v-model="name"
          ...
          <div class="flex items-center justify-between mb-6">
            <div class="flex items-center">
              ...
              <label for="agree" class="ml-2 text-sm text-gray-600">
                I agree to <a href="#" class="text-[#F62E56] font-medium hover:underline">Term & Condition</a>
              </label>
            </div>
          </div>
          <button
            type="submit"
            class="w-full py-3 bg-[#fff0f4] text-[#F62E56] border-2 border-[#F62E56] rounded-full font-semibold text-base md:text-lg hover:bg-[#F62E56] hover:text-white transition"
          >
            Sign up
          </button>
...
function handleRegister() {
  ...
  localStorage.setItem('currentUser', JSON.stringify({ email: email.value, name: name.value }))
  router.push('/login')
}
