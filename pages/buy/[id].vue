<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="container px-4 py-2 mx-auto text-sm text-gray-500">
      ...
      <span class="hover:text-[#F62E56] cursor-pointer"><NuxtLink to="/buy">Mua</NuxtLink></span>
      <span class="mx-2">/</span>
...
console.log('Trang chi tiết sản phẩm đã được render!', window.location.pathname)
</script>